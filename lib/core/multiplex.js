  ...
  return task_array.reduce(
    (a, c, i) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        if (arg_type === "OBJECT") {
          if (!sub$) return Object.assign(Object.assign({}, acc), args)
          command$.next(c)
        ...
        if (reso) {
          ...
          if (!(result instanceof Error)) {
            ...
            if (resolved && resolved[CMD_SUB$]) command$.next(resolved)
            else if (!sub$) return Object.assign(Object.assign({}, acc), resolved)
            result = resolved
          }
          console.warn(`no 'erro' (Error handler) set for ${c}`)
        }
        if (!reso && !sub$) return Object.assign(Object.assign({}, acc), result)
        if (result instanceof Error) {
